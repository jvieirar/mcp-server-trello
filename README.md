...
| #   | Step               | `trello` tokens | `jv-trello` tokens | Reduction |
| --- | ------------------ | --------------- | ------------------ | --------- |
...
`jv-trello` shapes every response for agent consumers, not UI renders: mutations return confirmation fields only, discovery calls return identification fields only.
